...
function App() {
  ...
  // useEffect(() => {
  //   let filteredArray = [`./img/eyes/${eyes}`, `./img/hats/${hat}`, `./img/skin/${skin}`];

  //   mergeImages(filteredArray).then(src => {
  //     setSrc(src);
  //   }).catch(err =>(
  //     console.log(err)
  //   ))
  ...
  return (
    <div className="App">
      <div className="canvas">
        {font && <img src={require(`./img/font/${font}`)} alt="skin_black" className="image"/>}
        {skin && <img src={require(`./img/skin/${skin}`)} alt="skin" className="image"/>}
        {hat && <img src={require(`./img/hats/${hat}`)} alt="hat" className="image"/>}
        {mouth && <img src={require(`./img/mouth/${mouth}`)} alt="mouth" className="image"/>}
        {eyes && <img src={require(`./img/eyes/${eyes}`)} alt="eyes" className="image"/>}
        {clothes && <img src={require(`./img/clothes/${clothes}`)} alt="clothes" className="image"/>}
      </div>
      {/* {src}
        {src ? <div><image src={src} height={500} width={500} /></div> : <div><p>Image Loading....</p></div>} */}

      <div className="attributes">
        <form>
          <label>
            <select value={eyes} onChange={(event) => setEyes(event.target.value)}>
              <option value="" selected disabled>Select eyes</option>
            ...
            <select value={mouth} onChange={(event) => setMouth(event.target.value)}>
              <option value="" selected disabled>Select mouth</option>
              ...
              <option value="mouth_2_with_diamond.png">Mouth 2 with diamond</option>
              <option value="mouth_3.png">Mouth 3</option>
              <option value="mouth_3_with_heart.png">Mouth 3 with heart</option>
              ...
              <option value="mouth_5_with_diamond.png">Mouth 5 with diamond</option>
              <option value="mustache_1.png">Mustache 1</option>
              <option value="mustache_1_with_heart.png">Mustache 1 with heart</option>
              <option value="mustache_2.png">Mustache 2</option>
              <option value="mustache_2_with_spade.png">Mustache 2 with spade</option>
              <option value="tobacco_pipe_1.png">Tobacco pipe</option>
            </select>

            <select value={hat} onChange={(event) => setHat(event.target.value)}>
              <option value="" selected disabled>Select hat</option>
            ...
            <select value={clothes} onChange={(event) => setClothes(event.target.value)}>
              <option value="" selected disabled>Select clothes</option>
              <option value="baloon_green.png">Baloon green</option>
              <option value="baloon_heart_red.png">Baloon heart red</option>
              <option value="baloon_heart_yellow.png">Baloon heart yellow</option>
              <option value="baloon_long_dark_purple.png">Baloon long dark purple</option>
              <option value="baloon_long_purple.png">Baloon long purple</option>
              <option value="baloon_long_yellow.png">Baloon long yellow</option>
            ...
            <select value={font} onChange={(event) => setFont(event.target.value)}>
              ...
              <option value="blue_with_purple_circles.png">Blue with purple circles</option>
              <option value="blue_with_purple_waves.png">Blue with purple waves</option>
              <option value="blue_with_white_circles.png">Blue with white circles</option>
              <option value="blue_with_white_waves.png">Blue with white waves</option>
              <option value="light_blue.png">Light blue</option>
              <option value="light_blue_rou.png">Light blue rou</option>
              <option value="light_blue_rou_invert.png">Light blue rou invert</option>
              <option value="light_green.png">Light green</option>
              <option value="light_green_rou.png">Light green rou</option>
              <option value="light_green_rou_invert.png">Light green rou invert</option>
              <option value="light_yellow.png">Light yellow</option>
              <option value="light_yellow_rou.png">Light yellow rou</option>
              <option value="light_yellow_rou_invert.png">Light yellow rou invert</option>
              ...
              <option value="pink_with_purple_circles.png">Pink with purple circles</option>
              <option value="pink_with_purple_waves.png">Pink with purple waves</option>
              <option value="pink_with_white_circles.png">Pink with white circles</option>
              <option value="pink_with_white_waves.png">Pink with white waves</option>
              ...
              <option value="purple_pink_rou_invert.png">Purple-pink rou invert</option>
              <option value="purple_with_blue_waves.png">purple with blue waves</option>
              <option value="purple_with_pink_circles.png">Purple with pink circles</option>
              <option value="purple_with_pink_waves.png">Purple with pink waves</option>
              <option value="purple_with_white_waves.png">Purple with white waves</option>
              <option value="purple_with_white_circles.png">Pink with white purple</option>
            </select>
          </label>
        </form>
      </div>
